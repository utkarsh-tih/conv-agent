...
class SessionManager:
    ...
    def __init__(self, customer_id: str, language: str = "english"):
        ...
        # Async queues for communication (create lazily to avoid event loop issues)
        ...
        try:
                ...
                if "You (customer):" in prompt or "CUSTOMER INPUT REQUIRED" in prompt:
                    try:
                        ...
                        future = asyncio.run_coroutine_threadsafe(
                            asyncio.wait_for(self.input_queue.get(), timeout=300), loop
                        )
                        return future.result(timeout=301)
                    except Exception as e:
            ...
            def custom_print(*args, **kwargs):
                ...
                if "Agent:" in text:
                    ...
                    # Send it via WebSocket using run_coroutine_threadsafe
                    if loop:
            ...
            final_state = await loop.run_in_executor(
                None, self.graph.invoke, self.state
            )
