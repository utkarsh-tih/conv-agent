...
class SessionManager:
    ...
    async def run_verification(self):
        ...
        try:
            ...
            def custom_print(*args, **kwargs):
                """Custom print - don't interfere with normal printing"""
                # Always use original print - don't capture anything
                original_print(*args, **kwargs)
                
                # Only send to WebSocket if it's explicitly an agent message
